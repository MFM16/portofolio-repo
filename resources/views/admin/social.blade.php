            ...
            <div class="flex flex-wrap -mx-3">
              <div class="items-center w-full max-w-full px-3 shrink-0">
                <div class="flex items-center mb-7">
                  <h6>{{ Auth::user()->profile->setting->language == 1 ? "Social Media" : 'Media Sosial' }}</h6>
                  <button type="button" class="btn-info ml-4" id="btn-modal">
                    <i class="fas fa-plus">&nbsp;</i></i>{{ Auth::user()->profile->setting->language == 1 ? "Add Account" : 'Tambah Akun' }}
                  </button>
                </div>
...
<div class="min-h-screen min-w-full h-full w-full backdrop-blur-md bg-transparent absolute z-990 top-0 flex items-center justify-center hidden" id="modal">
  <div class="modal-body">
    <div class="modal-header">
      <span class="modal-title">{{ Auth::user()->profile->setting->language == 1 ? "Add New Social Media Account" : 'Tambah Akun Media Sosial' }}</span>
    ...
    <form id="form-modal">
      <div>
        ...
        <input type="hidden" id="id_social" value="">
        ...
        <div class="grup-input">
          <div class="flex">
            <span class="form-title">URL</span>
            <span class="text-xs text-red-500 ml-1">*</span>
          </div>
    ...
    <div class="modal-footer">
      <button class="modal-button" type="button" id="btn-social">
